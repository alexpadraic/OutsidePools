User.create(email: 'bobbysags@gmail.com', name: 'Bob Saget', password: '123', bio: "Hey, I'm Bob", fav_artist: "Third Eye Blind")
User.create(email: 'sobbybags1@gmail.com', name: 'Sob Baget', password: '123', bio: "Hey, I'm Sob", fav_artist: "The Knocks")
Drive.create(user_id: 1,
             ...
             seats_available: 2,
             tolerance_in_miles: 5,
             description: "Willing to pick up along the way."
             )
